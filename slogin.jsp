<html lang="en">
<head>
  <title>Paperless | Student Login</title>
  <meta charset="utf-8">
...
<!--             <li><a href="fsignup.jsp">Faculty</a></li>
 -->            <li><a href="ssignup.jsp">Student</a></li>
  ...
  <div class="container">
    <center>
    <p style="font-family:tahoma;font-size: 30px;text-decoration: underline">Student Login</p>
   <div class="bottomShadow">
        ...
        <div class="card card-container">
            ...
            <form class="form-signin" action="/Paperless/slogin" method="post">
