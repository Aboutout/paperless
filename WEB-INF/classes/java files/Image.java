    ...
    try{
       if (part!=null) {
	     ...
	     final String PASS = "root";
          ...
          String qry1=String.format("select userid from images where userid=%d",id);
          ResultSet rs=st.executeQuery(qry1);

          if (rs.next()) {
            String sql1;
          sql1 ="update images set imgs=? where userid=?";
         ...
         String sql;
         sql = "insert into images(imgs,userid) values(?,?)";
