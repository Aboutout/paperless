...
public class data2 extends HttpServlet
{
  String RegNo="",output=" ";
	public void doPost(HttpServletRequest req,HttpServletResponse resp) throws ServletException,IOException
	{
		...
		String code=req.getParameter("content21");
		String input=req.getParameter("input2");
    ...
    String pracNo=req.getParameter("prac"); 
		...
		session.setAttribute("font2",font);		
		session.setAttribute("input2",input);
    session.setAttribute("sub2",sub);
    session.setAttribute("pracNo2",pracNo);		
    ...
    output=" ";
       ...
       BufferedWriter bufferedWriter = null;
        ...
        try {
          ...
          session.removeAttribute("output21");
          session.setAttribute("output21",output);
          resp.sendRedirect("/Paperless/dashboard.jsp");
  ...
  void CPPCodeCompiler(String code,PrintWriter out,String input,String sub,String pracNo,HttpSession session,HttpServletResponse resp)throws ServletException
  {
        output=" ";
        BufferedWriter bufferedWriter = null;
        File myFile=null;
  ...
  void PHPCodeCompiler(String code,PrintWriter out,String input,String sub,String pracNo,HttpSession session)throws ServletException,IOException
   ...
   void CodeStorage(String code,PrintWriter out,String input,String sub,String pracNo,HttpSession session)throws ServletException,IOException
   {
            ...
            {           
              try {
            ps = con.prepareStatement("insert into "+year+"(username,PracNo,code,Subject,SDate) values (?,?,?,?,?)");
            ...
            try{
            ps = con.prepareStatement("update "+year+" set code=?,PracNo=?,Subject=? where username=? and PracNo=? and Subject=?");
